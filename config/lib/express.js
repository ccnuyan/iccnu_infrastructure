...
module.exports.initMiddleware = function (app) {
    ...
    app.post('/api/resourcesImport/', upload.single('file', 12), function (req, res, next) {
        next();
    });
};
    ...
    app.use(function (err, req, res, next) {
        ...
        if (req.url.match(/^\/(api)\/.+/)) {
            ...
            if (err.message) {
                ...
                res.status(500).send({message: 'server api error'});
            }
        }
        else {
...
module.exports.disableCache = function (app) {
...
module.exports.init = function (db) {
    ...
    // Initialize catch configuration
