...
exports.invokeRolesPolicies = function () {
    acl.allow([{
        ...
        allows: [{
            ...
            resources: '/api/friends/:targetId',
            permissions: ['*']
        }, {
            resources: '/api/friendSearch/:username',
            permissions: ['*']
        }, {
            resources: '/api/share/:targetId',
            permissions: ['get']
        }, {
            resources: '/api/shareDownload/:fileId',
            permissions: ['get']
        }, {
            resources: '/api/move/:sourceDirectoryId/:targetDirectoryId/:fileId',
            permissions: ['put']
        }]
    }, {
        roles: ['guest'],
