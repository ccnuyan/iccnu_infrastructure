...
exports.search = function (req, res, next) {
    ...
    matches.push({match: {knowledgeNodeName: req.query.term}});
    ...
    if (req.query.subject) {
        filterFlag = true;
        filter.and.push({term: {subjectCode: req.query.subject}});
    }

    if (req.query.knowledgeNode) {
        filterFlag = true;
        filter.and.push({term: {knowledgeNode: req.query.knowledgeNode}});
    }
